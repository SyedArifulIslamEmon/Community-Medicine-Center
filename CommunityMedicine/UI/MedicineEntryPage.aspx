...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="medicineGridView" runat="server" AllowPaging="True" OnPageIndexChanging="medicineGridView_PageIndexChanging" PageSize="5" OnSelectedIndexChanged="medicineGridView_SelectedIndexChanged">
